...
class CaptionDataset(Dataset):
    def __init__(self, config: DataConfig):
        self.dataset = load_dataset(config.dataset_name, cache_dir=config.cache_dir, split=config.train_split)
...
def build_dataloader(
    ...
    dataset = CaptionDataset(config)
    dataloader = DataLoader(
        dataset, 
        batch_size=config.batch_size, 
        shuffle=config.train_split == "train", 
